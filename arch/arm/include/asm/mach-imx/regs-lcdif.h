...
#if defined(CONFIG_MX28) || defined(CONFIG_IMX6SX) || defined(CONFIG_IMX6UL) || \
	defined(CONFIG_MX7) || defined(CONFIG_IMX6SL) || defined(CONFIG_IMX6SLL)
...
#if defined(CONFIG_IMX6SX) || defined(CONFIG_IMX6UL) || defined(CONFIG_MX7) || \
